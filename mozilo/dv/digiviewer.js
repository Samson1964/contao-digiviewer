...
//			if (Prototype.Gecko || Prototype.IE || Prototype.Webkit) // IE, FF and Safari handle this right
				document.location.replace('#DV_' + page.id);
...
var DV_Pager = Class.create(NavbarElement, {
	initialize: function($super) {
		$super();
		this.content.insert('<div id="dv_pager"><a id="pager_link_first" onclick="return(false)" href="#"><img id="pager_img_first" src="/plugins/DigiViewer/dv/images/first.gif" alt="|&lt;" title="First" /></a><a id="pager_link_prev" onclick="return(false)" href="#"><img id="pager_img_prev" src="/plugins/DigiViewer/dv/images/previous.gif" alt="&lt;" title="Previous" /></a><span id="pager_pagina" title="aktuelle Seite">###</span><a id="pager_link_next" onclick="return(false)" href="#"><img id="pager_img_next" src="/plugins/DigiViewer/dv/images/next.gif" alt="&gt;" title="Next" /></a><a id="pager_link_last" onclick="return(false)" href="#"><img id="pager_img_last" src="/plugins/DigiViewer/dv/images/last.gif" alt="&gt;|" title="Last" /></a></div>');
	},
	firstPage: function() {
	...
	_adjustView: function() {
		...
		$('pager_link_first').href = '#DV_' + this.viewer_obj.pageList[0].id;
		if (index > 0) $('pager_link_prev').href = '#DV_' + this.viewer_obj.pageList[index-1].id;
		if (index < this.viewer_obj.pageList.length-1) $('pager_link_next').href = '#DV_' + this.viewer_obj.pageList[index+1].id;
		$('pager_link_last').href = '#DV_' + this.viewer_obj.pageList[this.viewer_obj.pageList.length-1].id;
		if (index == 0) {
			$('pager_link_first').setStyle('visibility:hidden');
			$('pager_link_prev').setStyle('visibility:hidden');
		}
...
var DV_Zoomer = Class.create(NavbarElement, {
	initialize: function($super, opts) {
		...
		this.content.insert('<div id="dv_zoomer"><a id="zoomer_link_zoomOut" onclick="return(false)" href="javascript:function(){return false;}"><img src="/plugins/DigiViewer/dv/images/zoom-out.gif" alt="minus" title="zoom out" /></a><select id="zoomer_select" onchange="">' + option_list + '</select><a id="zoomer_link_zoomIn" onclick="return(false)" href="javascript:function(){return false;}"><img src="/plugins/DigiViewer/dv/images/zoom-in.gif" alt="plus" title="zoom in" /></a></div>');
	},
...
var DV_Rotator = Class.create(NavbarElement, {
	initialize: function($super, opts) {
		...
		this.content.insert('<div id="dv_rotator"><a id="rotator_link_left" onclick="return(false)" href="javascript:function(){return false;}"><img src="/plugins/DigiViewer/dv/images/object-rotate-left.png" alt="links" title="turn left" /></a><img style="" src="/plugins/DigiViewer/dv/images/doc.gif" alt="" title="turn page" /><a id="rotator_link_right" onclick="return(false)" href="javascript:function(){return false;}"><img src="/plugins/DigiViewer/dv/images/object-rotate-right.png" alt="rechts" title="turn right" /></a></div>');
	},
...
var DV_Thumbs = Class.create(SidebarElement, {
	initialize: function($super, slideWidth) {
		$super({'id':'dv_thumb', 'iconSource': '/plugins/DigiViewer/dv/images/image.gif', 'slideWidth': slideWidth, 'title': 'Preview'});
	...
	addThumb: function(page, src) {
		if (page._class == 'page_instance' && src) {
			this.slideWindow.insert('<a id="thumb_' + page.id + '" class="dv_thumb_link" onclick="return(false)" href="#DV_' + page.id + '"><img src="' + src + '" /><span><br />' + page.pageNum + '</span></a>');
...
function DV_Help() {
	var helper = new SidebarElement({'id': 'dv_settings', 'iconSource': '/plugins/DigiViewer/dv/images/help.gif', 'slideWidth': 250, 'title': 'Help'});
